...
public class OperationData {
    ...
    public static final int OPERATION_CLICK_DOWN = 1;     //WHY THERE IS NO LEFT CLICK OPTION???
    ...
    //
    private String inputStr;              //WHAT IS THE USE OF INPUTSTR FOR DEFINING OPERATION???
    ...
    @Override
    public String toString() {         //WHY TOSTRING METHOD IS OVERRIDDEN
        String oper;
